...
public class HamstersItems {
    ...
    public static final RegistryObject<Item> HAMSTER_SPAWN_EGG = ITEMS.register("hamster_spawn_egg", () -> new ForgeSpawnEggItem(HamstersEntityType.HAMSTER, 16747824, 16775119, new Item.Properties()));
