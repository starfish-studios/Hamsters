...
public class HamstersItems {
    ...
    public static final Item HAMSTER_SPAWN_EGG = register("hamster_spawn_egg", new SpawnEggItem(HamstersEntityType.HAMSTER, 0x443626, 0xE8DBCD, new FabricItemSettings()));
